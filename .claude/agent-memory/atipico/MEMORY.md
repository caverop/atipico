...
- [SendMessage no funciona acá](atipico-sesion-principal-y-sendmessage.md) — usar `mcp__ccd_session_mgmt__*` para gestionar sesiones hermanas. Esta sesión es la principal desde el 2026-09-10.
