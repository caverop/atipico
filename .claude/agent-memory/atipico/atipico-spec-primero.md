...
**Formato del documento.** Cada feature tiene el suyo en `docs/<feature>.md`, en
...
que hacerlo con el código escrito. Además ya pasó dos veces en la feature de turnos
...
actualizar `docs/<feature>.md` (diseño + reglas de negocio + criterios de
