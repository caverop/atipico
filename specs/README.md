...
27 specs, más este índice. Cada feature de Atipico tiene el suyo, y el spec es el
...
Hoy: **4 propuestos · 0 aprobados · 14 implementados · 8 en producción · 1 descartado**.
...
| [auditoria-specs](auditoria-specs.md) | `implementado` | La auditoría de `specs/`: tres dimensiones —estado vs índice con modelo local, formato obligatorio mecánico, y contenido a juicio—, reporta con evidencia y no reescribe. Primera corrida hecha: 24 OK, 1 DISCREPA, 1 REVISAR, con dos defectos corregidos |
