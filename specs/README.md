...
Hoy: **5 propuestos · 1 aprobado · 11 implementados · 7 en producción**.
...
| [reservas](reservas.md) | `propuesto` | Formulario público de reserva de mesa, más pantalla interna para confirmarlas |
